import { moveLeft, moveRight, moveVertical, moveWordNext, moveWordPrev, moveWordEnd, selectLine, selectFile, gotoFileStart, gotoFileEnd, gotoLineStart, gotoLineEnd, gotoFirstNonWhitespace } from './motions.js'
